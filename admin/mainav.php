    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <?php
                    ...
                    var dayNames = new Array("SUN","MON","TUE","WEN","THU","FIR","SAT");
			        ...
			        function getTime(){
				        var t=new Date(ts);
				        with(t){
                            var _time=""+getFullYear()+"-" + 
                            (getMonth()+1)+"-"+getDate()+" " + 
                            (getHours()<10 ? "0" :"") + getHours() + ":" + 
                            (getMinutes()<10 ? "0" :"") + getMinutes() + ":" + 
                            (getSeconds()<10 ? "0" :"") + getSeconds() + " " + dayNames[t.getDay()];
				        }
            ...
            <ul class="nav nav-pills">
                ...
                <li role="presentation" <?php echo ($index == 1) ? 'class="active"' : ''; ?>><a href="bigthings_list.php">大事紀管理</a></li>
